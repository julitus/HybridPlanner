...
int main(int argc, char *argv[])
{
    ...
    */
    ...
    Planner<Num> *pl3 = new Planner<Num>(3, 9, 5, true);
    pl3->print();
    ...
    Planner<Num> *pl4 = new Planner<Num>(1, 7, 3, false, 80, 10);
    pl4->print();
